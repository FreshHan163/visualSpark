...
<template>
  <div class="layout-wrap">
    <div class="heatmap-chart" id="heatDestPort" style="width: 400px;height: 400px;"></div>
  </div>
</template>

<script>
export default {
  name: 'HeatmapdestPort',
  data () {
    return {
      msg: 'hello',
      instances: []
          ...
          title: {
            ...
            tooltip: {
                ...
                formatter: function(params) {
                    ...
                    res += instances[subIndex].destPort;
